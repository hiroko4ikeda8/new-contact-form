        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--tel">
                    <input type="text" name="tel1" pattern="\d{1,5}" placeholder="090" value="{{ old('tel1') }}" />
                    <span>-</span>
                    <input type="text" name="tel2" pattern="\d{1,5}" placeholder="1234" value="{{ old('tel2') }}" />
                    <span>-</span>
                    <input type="text" name="tel3" pattern="\d{1,5}" placeholder="5678" value="{{ old('tel3') }}" />
                </div>
                <div class="form__error">
